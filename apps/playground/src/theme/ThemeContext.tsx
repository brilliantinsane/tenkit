...
import { getBrandColors, type ResolvedBrand, type SystemColors, useSystemColors } from './colors';
...
export type SystemThemeColor = keyof SystemColors;
export type ThemeColor = SystemThemeColor | keyof ResolvedBrand;
export type BrandOverride = Partial<ResolvedBrand>;
...
export function ColorsProvider({
  ...
  return <ThemeContext.Provider value={{ colors, brand, dark }}>{children}</ThemeContext.Provider>;
}
