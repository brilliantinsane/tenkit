...
interface TreeViewBranchTitleProps extends React.ComponentProps<
...
interface TreeViewItemProps extends React.ComponentProps<
  typeof TreeViewItemTitle
> {
  /**
   * Custom file icon
   *
...
export const TreeViewItem = (props: TreeViewItemProps) => {
  ...
  const { fileIcons } = useTreeViewContextValue()
