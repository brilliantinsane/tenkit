  ...
  return (
    <ArkColorPicker.TransparencyGrid
      className={cn(
        ...
        "bg-size-(--spacing(2)) bg-position-[0_0,0_4px,4px_-4px,-4px_0]",
        className
      )}
      {...rest}
    />
    ...
    >
      ...
      <ArkColorPicker.ChannelSliderThumb
        className={cn(
          ...
          "ring-1 ring-border/64 outline-none",
...
interface ColorPickerEyeDropperTrigger extends React.ComponentProps<
...
export const ColorPickerEyeDropperTrigger = (
  ...
  const { variant = "outline", size = "icon-sm", children, ...rest } = props
  ...
  return (
    <ArkColorPicker.SwatchTrigger
      className={cn(
        ...
        "data-[state=checked]:shadow-sm/5 data-[state=checked]:ring-2 data-[state=checked]:ring-(--color)",
  ...
  return (
    <ArkColorPicker.SwatchIndicator
      className={cn(
        ...
        "text-white",
        "pointer-events-none",
        "animate-in zoom-in-5 blur-in-md",
        "[&_svg]:size-1/2",
        "motion-reduce:animate-none!",
        className
      )}
